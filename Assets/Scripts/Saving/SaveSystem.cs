...
public class SaveSystem : MonoBehaviour
{
    ...
    public void Save()
    {
        ...
        string playerPath = GetPath($"player.dat");
        ...
        PlayerData playerData = new PlayerData()
        {
            ...
            totalSoulsCollected = Player.instance.totalSoulsCollected,
        };
        ...
        if (sceneIndex != 0)
        {
            string scenePath = GetPath($"scene{sceneIndex}.dat");
    ...
    public void Load()
    {
        ...
        Player.instance.totalSoulsCollected = playerData.totalSoulsCollected;
        HealthSystem playerHealthSystem = Player.instance.GetComponent<HealthSystem>();
        playerHealthSystem.health = playerData.health;
        playerHealthSystem.HealthUpdate(false);

        string scenePath = GetPath($"scene{playerData.sceneIndex}.dat");
    ...
    {
        int sceneIndex = SceneManager.GetActiveScene().buildIndex;
        return File.Exists(GetPath($"scene{sceneIndex}.dat"));
    }
}
